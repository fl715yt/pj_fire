...
if __name__ == "__main__":
    # Diverse: Large caps, small/mid, eventful, dull, and weird dates
    test_cases = [
        ("7203", "2024-05-10"),   # TOYOTA, top cap, should return news
        ("9984", "2024-04-30"),   # SoftBank, frequent headline
        ("3436", "2024-05-09"),   # SUMCO, sector action, mid cap
        ("8058", "2024-03-28"),   # Mitsubishi Corp, bluechip, sometimes noisy
        ("8306", "2024-01-18"),   # MUFG, mega cap, always news
        ("9501", "2024-02-13"),   # TEPCO, utilities, event-driven
        ("3769", "2024-04-18"),   # GMO-PG, tech, not always news
        ("2432", "2024-01-18"),   # DeNA, mid cap, some action
        ("7065", "2024-03-08"),   # UPR, small cap, usually boring
        ("6758", "2024-05-02"),   # Sony, electronics, should always hit
        # Additional: new/boring/surprise
        ("2702", "2024-05-13"),   # 日本マクドナルド, steady, should sometimes pop
        ("4523", "2024-03-07"),   # エーザイ, pharma, volatile news
        ("9022", "2024-04-02"),   # JR東海, transport, mixed
        ("6981", "2024-02-19"),   # 村田製作所, electronics, may be quiet
    ]
